...
fun <T> checkType(args: T): String {
    ...
    when (args) {
        is Int -> resultReturn = "Yes! it's Integer"
        is String -> resultReturn = "Yes! it's String"
        is Boolean -> resultReturn = "Yes! it's Boolean"
        is Double -> resultReturn = "Yes! it's Double"
        is List<*> -> resultReturn = "Yes! it's List"
        is Map <*, *> -> resultReturn = "Yes! it's Map"
    }
    return resultReturn
}
